...
export default function MandatSepa({
  client,
  cabinetNom,
  cabinetIcs,
  cabinetAdresse,
}: MandatSepaProps) {
  const tpl = LETTRE_MISSION_TEMPLATE.mandatSepa;
  const rum = tpl.rum
  ...
  return (
    <div className="border border-gray-300 rounded-lg bg-white">
      <div className="bg-[#0f172a] text-white px-6 py-4 rounded-t-lg flex items-center gap-3">
        ...
        <h3 className="text-lg font-semibold">{tpl.titre}</h3>
      </div>
      ...
      <div className="p-6 space-y-6 text-sm">
        ...
        <div className="text-xs text-gray-500">
          Type de prélèvement : <strong>{tpl.typePrelevement}</strong>
        </div>
        ...
        <div>
          ...
          <div className="grid grid-cols-2 gap-2">
            ...
            <div className="col-span-2">
              ...
              <p className="text-gray-800">{cabinetAdresse}</p>
            </div>
          </div>
        </div>
