...
export interface MissionTypeConfig {
  ...
  specificVariables: { key: string; label: string; placeholder: string }[];
...
export const MISSION_TYPES = {
  ...
  examen_limite: {
    ...
    honorairesSuccesAutorises: false,
    specificVariables: [
      { key: 'nature_informations_client', label: 'Nature des informations à communiquer par le client', placeholder: 'Documents comptables, pièces justificatives, analyses de comptes...' }
    ],
    cgvSpecificClauses: []
  },
  ...
  audit_contractuel: {
    ...
    honorairesSuccesAutorises: false,
    specificVariables: [
      { key: 'composition_equipe', label: "Composition de l'équipe d'audit", placeholder: 'Noms et fonctions des intervenants' },
      { key: 'planning_audit', label: "Planning d'intervention", placeholder: 'Dates prévisionnelles des phases (intérimaire, final)' },
      { key: 'auditeur_precedent', label: 'Auditeur précédent (si audit initial)', placeholder: 'Nom du cabinet précédent ou N/A' }
    ],
    cgvSpecificClauses: [
  ...
  attestation_particuliere: {
    ...
    honorairesSuccesAutorises: false,
    specificVariables: [
      { key: 'objet_attestation', label: "Objet de l'attestation (information sur laquelle portera l'attestation)", placeholder: "Ex : chiffre d'affaires, effectifs, respect d'un covenant bancaire..." },
      { key: 'nature_travaux_attestation', label: 'Nature des travaux à réaliser', placeholder: "Ex : rapprochement avec la comptabilité, contrôle de pièces, entretiens..." },
      { key: 'participation_elaboration', label: "Participation à l'élaboration de l'information", placeholder: "Le responsable de mission a / n'a pas participé à l'élaboration de l'information" },
      { key: 'niveau_assurance', label: "Niveau d'assurance (raisonnable ou modéré)", placeholder: 'Assurance raisonnable / Assurance modérée' }
    ],
    cgvSpecificClauses: []
  },
  ...
  previsionnel: {
    ...
    honorairesSuccesAutorises: false,
    specificVariables: [
      { key: 'periode_debut_prev', label: 'Début de la période prévisionnelle', placeholder: 'JJ/MM/AAAA' },
      { key: 'periode_fin_prev', label: 'Fin de la période prévisionnelle', placeholder: 'JJ/MM/AAAA' },
      { key: 'utilisation_prevue', label: 'Utilisation prévue des informations', placeholder: "Ex : recherche de financement, plan d'affaires, business plan cession..." },
      { key: 'destinataires_info', label: 'Destinataires des informations', placeholder: 'Ex : établissements bancaires, investisseurs, direction' },
      { key: 'type_diffusion', label: 'Type de diffusion', placeholder: 'Générale / Restreinte' },
      { key: 'nature_hypotheses', label: 'Nature des hypothèses', placeholder: 'Estimations les plus plausibles / Hypothèses théoriques' }
    ],
    cgvSpecificClauses: []
  },
  ...
  procedures_convenues: {
    ...
    specificVariables: [
      { key: 'contexte_mission', label: 'Contexte de la mission', placeholder: "Ex : due diligence, vérification d'un accord contractuel..." },
      { key: 'informations_examinees', label: 'Informations sur lesquelles portent les procédures', placeholder: "Ex : comptes de charges, contrats fournisseurs, état des créances..." },
      { key: 'procedures_detail', label: 'Détail des procédures à mettre en œuvre', placeholder: "Lister chaque procédure numérotée : 1. Rapprochement de... 2. Vérification de..." },
      { key: 'calendrier_procedures', label: 'Calendrier des procédures', placeholder: "Ex : Phase 1 en mars, Phase 2 en avril, rapport en mai" },
      { key: 'diffusion_rapport', label: 'Limites de diffusion du rapport', placeholder: "Ex : Diffusion restreinte aux parties au contrat" }
    ],
    cgvSpecificClauses: [
  ...
  compilation: {
    ...
    honorairesSuccesAutorises: true,
    specificVariables: [
      { key: 'nature_informations_client', label: 'Nature des informations à communiquer par le client', placeholder: 'Grand livre, balances, pièces justificatives...' }
    ],
    cgvSpecificClauses: []
  },
  ...
  activite_commerciale: {
    ...
    honorairesSuccesAutorises: true,
    specificVariables: [
      { key: 'description_activite', label: "Description de l'activité", placeholder: "Ex : intermédiation en assurances, vente de logiciels, formation..." },
      { key: 'detail_travaux_activite', label: 'Détail des travaux', placeholder: "Décrire les prestations concrètes" }
    ],
    cgvSpecificClauses: []
  },
  ...
  autre_prestation: {
    ...
    honorairesSuccesAutorises: true,
    specificVariables: [
      { key: 'description_prestation', label: 'Description de la prestation', placeholder: "Ex : accompagnement à la création, évaluation d'entreprise, conseil en organisation..." },
      { key: 'detail_travaux_prestation', label: 'Détail des travaux', placeholder: "Décrire les prestations concrètes" }
    ],
    cgvSpecificClauses: []
  }
