    ...
    <div className="p-6 lg:p-8 max-w-[1200px] mx-auto space-y-6">
      ...
      <Tabs value={activeTab} onValueChange={handleTabChange} className="space-y-6">
        ...
        <TabsContent value="missions">
          <Suspense fallback={<div className="glass-card border border-white/10 rounded-xl p-6 space-y-3"><div className="h-5 w-48 bg-white/5 rounded animate-pulse" /><div className="h-4 w-64 bg-white/5 rounded animate-pulse" /><div className="h-8 w-full bg-white/5 rounded animate-pulse" /></div>}>
            <RefMissionsTab />
          </Suspense>
        </TabsContent>
        ...
        {/* ===== TYPES JURIDIQUES TAB ===== */}
        <TabsContent value="types-juridiques">
          <Suspense fallback={<div className="glass-card border border-white/10 rounded-xl p-6 space-y-3"><div className="h-5 w-48 bg-white/5 rounded animate-pulse" /><div className="h-4 w-64 bg-white/5 rounded animate-pulse" /><div className="h-8 w-full bg-white/5 rounded animate-pulse" /></div>}>
            <RefTypesJuridiquesTab />
          </Suspense>
        </TabsContent>
