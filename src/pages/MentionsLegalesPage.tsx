    ...
    <div className="min-h-screen bg-gray-50 dark:bg-slate-950 text-slate-900 dark:text-white px-4 py-16">
      <div className="max-w-3xl mx-auto space-y-10">
        ...
        <section className="space-y-3">
          <h2 className="text-2xl font-serif font-semibold text-slate-800 dark:text-slate-200">Éditeur du site</h2>
        ...
        <section className="space-y-3">
          <h2 className="text-2xl font-serif font-semibold text-slate-800 dark:text-slate-200">Hébergement</h2>
          <p className="text-slate-700 dark:text-slate-300 leading-relaxed">
        ...
        <section className="space-y-3">
          <h2 className="text-2xl font-serif font-semibold text-slate-800 dark:text-slate-200">Propriété intellectuelle</h2>
          <p className="text-slate-700 dark:text-slate-300 leading-relaxed">
        ...
        <section className="space-y-3">
          <h2 className="text-2xl font-serif font-semibold text-slate-800 dark:text-slate-200">Responsabilité</h2>
          <p className="text-slate-700 dark:text-slate-300 leading-relaxed">
        ...
        <section className="space-y-3">
          <h2 className="text-2xl font-serif font-semibold text-slate-800 dark:text-slate-200">Données personnelles</h2>
          <p className="text-slate-700 dark:text-slate-300 leading-relaxed">
