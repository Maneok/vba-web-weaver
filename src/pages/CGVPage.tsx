    ...
    <div className="min-h-screen bg-slate-950 text-white px-4 py-16">
      <div className="max-w-3xl mx-auto space-y-10">
        ...
        <section className="space-y-3">
          <h2 className="text-2xl font-serif font-semibold text-slate-200">Article 1 — Objet</h2>
        ...
        <section className="space-y-3">
          <h2 className="text-2xl font-serif font-semibold text-slate-200">Article 2 — Tarifs</h2>
          <p className="text-slate-300 leading-relaxed">Les offres disponibles sont les suivantes :</p>
        ...
        <section className="space-y-3">
          <h2 className="text-2xl font-serif font-semibold text-slate-200">Article 3 — Paiement</h2>
          <p className="text-slate-300 leading-relaxed">
        ...
        <section className="space-y-3">
          <h2 className="text-2xl font-serif font-semibold text-slate-200">Article 4 — Durée et résiliation</h2>
          <p className="text-slate-300 leading-relaxed">
        ...
        <section className="space-y-3">
          <h2 className="text-2xl font-serif font-semibold text-slate-200">Article 5 — Limitation de responsabilité</h2>
          <p className="text-slate-300 leading-relaxed">
        ...
        <section className="space-y-3">
          <h2 className="text-2xl font-serif font-semibold text-slate-200">Article 6 — Données personnelles</h2>
          <p className="text-slate-300 leading-relaxed">
        ...
        <section className="space-y-3">
          <h2 className="text-2xl font-serif font-semibold text-slate-200">Article 7 — Droit applicable</h2>
          <p className="text-slate-300 leading-relaxed">
