    ...
    <div className="min-h-screen bg-gray-50 dark:bg-slate-950 text-slate-900 dark:text-white px-4 py-16">
      <div className="max-w-3xl mx-auto space-y-10">
        ...
        <section className="space-y-3">
          <h2 className="text-2xl font-serif font-semibold text-slate-800 dark:text-slate-200">Responsable du traitement</h2>
        ...
        <section className="space-y-3">
          <h2 className="text-2xl font-serif font-semibold text-slate-800 dark:text-slate-200">Finalités du traitement</h2>
          <p className="text-slate-700 dark:text-slate-300 leading-relaxed">
        ...
        <section className="space-y-3">
          <h2 className="text-2xl font-serif font-semibold text-slate-800 dark:text-slate-200">Données collectées</h2>
          <ul className="list-disc list-inside text-slate-700 dark:text-slate-300 space-y-1">
        ...
        <section className="space-y-3">
          <h2 className="text-2xl font-serif font-semibold text-slate-800 dark:text-slate-200">Sous-traitants</h2>
          <p className="text-slate-700 dark:text-slate-300 leading-relaxed">
        ...
        <section className="space-y-3">
          <h2 className="text-2xl font-serif font-semibold text-slate-800 dark:text-slate-200">Durée de conservation</h2>
          <p className="text-slate-700 dark:text-slate-300 leading-relaxed">
        ...
        <section className="space-y-3">
          <h2 className="text-2xl font-serif font-semibold text-slate-800 dark:text-slate-200">Vos droits</h2>
          <p className="text-slate-700 dark:text-slate-300 leading-relaxed">
        ...
        <section className="space-y-3">
          <h2 className="text-2xl font-serif font-semibold text-slate-800 dark:text-slate-200">Sécurité</h2>
          <p className="text-slate-700 dark:text-slate-300 leading-relaxed">
